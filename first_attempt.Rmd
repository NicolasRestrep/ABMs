...
```{r}
values <- tibble(w4 = rnorm(1, 1, n = 100), 
                 w2 = rnorm(0.5, 1, n = 100), 
                 w3 = rnorm(0.75, 1, n = 100), 
                 w1 = rnorm(0.25, 1, n = 100)) %>% 
  gather()
...
after_each_round <- matrix(0, 30, 250)
...
for (k in 1:250) {
  ...
  for (i in 1:30) {
    ...
    w1 <- rnorm(0.25, 1, n = data$h1[i])
    
    w2 <- rnorm(0.5, 1, n = data$h2[i])
    
    w3 <- rnorm(0.75, 1, n = data$h3[i])
    
    w4 <- rnorm(1, 1, n = data$h4[i])
